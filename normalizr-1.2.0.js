...
(function(GLOBAL, CONTEXT, factory) {
    ...
    (function() {
        ...
        try {
            ...
            __magic__.globalThis = __magic__; // The previous line should have made `globalThis` a globally available variable, but it fails in Internet Explorer 10 and older.
    ...
    (function() {
        if (typeof window !== 'undefined' && window && window.window === window && typeof window.document !== 'undefined') { return 'window' } // all browsers
    ...
    // FACTORY: the factory modular code.
    // BEGINNING OF FACTORY FUNCTION
    function _factory( GLOBAL, context, undefined ) {
